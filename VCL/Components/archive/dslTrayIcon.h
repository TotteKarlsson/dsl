...
enum mtkTrayIconMessage
{
	imClick, imDoubleClick, imMouseDown, imMouseUp, imLeftClickUp, imLeftDoubleClick,
    imRightClickUp, imRightDoubleClick, imNone
};

//---------------------------------------------------------------------------
class PACKAGE mtkTrayIcon : public TComponent
{
private:
   ...
   bool                 FHide;
   bool                 FAnimate;
   mtkTrayIconMessage   FAppRestore;
   mtkTrayIconMessage   FToggleVisibility;   
   mtkTrayIconMessage   FPopupMenuShow;
...
public:
    __fastcall mtkTrayIcon(TComponent* Owner);
    __fastcall ~mtkTrayIcon();
    ...
    void         __fastcall ToggleVisibility();
...
__published:
   ...
   __property mtkTrayIconMessage RestoreOn = {read=FAppRestore,write=FAppRestore};
   __property mtkTrayIconMessage ToggelVisibility = {read=FToggleVisibility,write=FToggleVisibility};
   __property mtkTrayIconMessage PopupMenuOn = {read=FPopupMenuShow,write=FPopupMenuShow};
